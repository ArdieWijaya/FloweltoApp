                ...
                <div class="col-md-8">
                    ...
                    <form method="POST" action={{ route('updateflower', $flower->id) }} class="form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="flowerName" type="text" class="form-control" name="flowerName" value="{{ $flower->flowerName }}">
                        </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="flowerPrice" type="number" class="form-control" name="flowerPrice" min="50000" value="{{ $flower->flowerPrice }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                <textarea class="form-control" id="description" name="description" rows="3"> {{ $flower->description }}</textarea>
                                </div>
                            </div>
